...
ENCRYPTION_KEY = b'7s4Q3dRnSDFfrfA202ELzX_Hp9dWBidaSVzHHx53Ffg='  # Use Fernet.generate_key() to make this
...
ENCRYPTED_OPENAI_KEY = fernet.encrypt(b"REMOVED_OPENAI_KEY")  # Replace with real key
